...
namespace AST {
    ...
    // Base AST Node - All other nodes derive from this
    class ASTNode {
    public:
        int lineno;
        ...
        explicit ASTNode(int no) : lineno(no), children(), returnType(), num(), reg(), record(nullptr) {}
    ...
    public:
        ...
        void print(int level) override {
            cout << string(level, '\t') + "primary "<<Expression::returnType << endl;
    ...
    // This node used in the main loop and is passed to other functions
