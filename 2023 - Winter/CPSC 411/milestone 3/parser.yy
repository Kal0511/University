...
Source          : %empty
                | Source TopLevelDecl SEMI_COLON_T                                  {program.children.push_back($2);}
                ;
...
Signature       : Parameters                                                        {$$ = new AST::FunctionSignature(@$.begin.line ,(std::vector<AST::Parameter *>*)$1,"void");}
...
Arguments       : BRACKET_OPEN_T BRACKET_CLOSE_T                                        {$$ = new std::vector<AST::ASTNode *>();;}
...
UnaryExpr       : PrimaryExpr                                           {$$ = $1;((AST::PrimaryExpression*)$$)->update();}
...
Literal         : NUMBER_T                                              {$$ = new AST::Literal(@$.begin.line, $1, "int");}
...
Assignment      : Expression ASSIGN_T Expression                        {$$ = new AST::Assignment(@$.begin.line, (AST::Expression*)$1, (AST::Expression*)$3);}
                ;

IfStmt          : IF_T Expression Block                                 {$$ = new AST::If(@$.begin.line,(AST::Expression*)$2,(AST::Block*)$3,nullptr);}
                | IF_T Expression Block ELSE_T Block                    {$$ = new AST::If(@$.begin.line,(AST::Expression*)$2,(AST::Block*)$3,(AST::Block*)$5);}
                | IF_T Expression Block ELSE_T IfStmt                   {$$ = new AST::IfElse(@$.begin.line,(AST::Expression*)$2,(AST::Block*)$3,(AST::Block*)$5);}
                ;
