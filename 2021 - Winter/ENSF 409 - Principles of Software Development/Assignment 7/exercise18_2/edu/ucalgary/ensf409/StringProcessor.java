...
public class StringProcessor{
	...
	public static void main(String[] args) {
		StringProcessor one = new StringProcessor("  HI fbwfib, bdqdbHHVHs ");
		...
		System.out.println(one.secretCode(25));
	}
