...
int main() {
    //cout << "b dictionary_tests" << endl;
    DictionaryList dl = dictionary_tests();
    //cout << "a dictionary_tests" << endl;

    //cout << "b test_copying" << endl;
    test_copying();
    //cout << "a test_copying" << endl;
...
void test_copying() {
    ...
    one = two = three = three;
    //cout << "one.remove(319);" << endl;
    one.remove(319);
    //cout << "two.remove(315);" << endl;
    two.remove(315);
    //cout << "end" << endl;
