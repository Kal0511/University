...
Rectangle::Rectangle(const double &x, const double &y, const double &sideA, const double &sideB, const char* name) : Shape(x, y, name), Square(x,y,sideA,name), side_b(sideB) {}
